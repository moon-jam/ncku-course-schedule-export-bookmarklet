...
<h2>功能</h2>
<ul class="feat">
<li>同一天連續節次的同一門課，自動合併成單一事件（間隔小於 30 分鐘視為連續）。</li>
<li>每門課的標題可編輯，重複週數可個別調整。</li>
<li>跳過日期：可設定跳過日期清單套用所有課程（如國定假日），個別課程可再新增自己的跳過日期。</li>
<li>可選的每週日週數提醒，標題為「成功大學第 N 週」。</li>
<li>時間未定或彈性時間課程（含彈性密集）會在儀表板列出。</li>
</ul>
...
<p class="contact">有問題歡迎開 <a href="${REPO}/issues" target="_blank" rel="noopener">issue</a>／<a href="${REPO}/pulls" target="_blank" rel="noopener">PR</a>，或<a href="mailto:wu.messi.wu@gmail.com">寫信給我</a>。</p>
</footer>
</body>
</html>`;
